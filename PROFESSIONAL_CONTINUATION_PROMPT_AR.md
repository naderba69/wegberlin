...
- 12 عائلة Zod صارمة تتحقق عند `prebuild` من 3,402 كائنًا أكاديميًا علويًا وبنيته المتداخلة، ومنها 336 سجل اسم يحمل كل واحد صيغة Genitiv مفردة وجمعًا مجرورًا أو تصريحًا بعدمه، و262 إطار فعل/حرف جر عبر كل المستويات (144 إطارًا مؤلفًا: A1 24، A2 48، B1 48، B2 24؛ زائد 118 إطارًا مشتقًا من جرد تكافؤ مقاس من نصوص الدروس، و141 هدفًا مقيسًا بلا فجوة، و118 إطارًا مشتقًا مسوَّغًا بجملة مقتبسة، و0 إطار مشتق بلا مسوّغ)؛ تغيير المحتوى دون إعادة توليد التقارير يفشل Build.
