...
- 12 عائلة Zod صارمة تتحقق عند `prebuild` من 3,025 كائنًا أكاديميًا علويًا وبنيته المتداخلة، ومنها 336 سجل اسم و144 إطار فعل/حرف جر عبر كل المستويات (A1: 96 اسمًا و24 إطارًا، A2: 96 و48، B1: 96 و48، B2: 48 و24)؛ تغيير المحتوى دون إعادة توليد التقارير يفشل Build.
