...
Offline cache: dwnb-full-pack-v58
Offline level caches: dwnb-level-pack-a1-v58, dwnb-level-pack-a2-v58, dwnb-level-pack-b1-v58, dwnb-level-pack-b2-v58
...
- 12 عائلة Zod صارمة تتحقق عند `prebuild` من 4,854 كائنًا أكاديميًا علويًا وبنيته المتداخلة، ومنها 664 سجل اسم (336 مرسى مؤلفًا عبر 84/84 درسًا، و328 سجلًا مشتقًا من جرد الأسماء: 460 اسمًا هدفًا مقيسًا — 280 من مسارد القراءة و180 من العبارات الاسمية المستقلة في بطاقات الدروس وعباراتها — و0 فجوة، يرث الصرف من مرسى آخر عند وجوده) و262 إطار فعل/حرف جر، و252 موضع دليل مؤلف لأسئلة القراءة (23 منها استنتاج معلن) (144 إطارًا مؤلفًا: A1 24، A2 48، B1 48، B2 24؛ زائد 118 إطارًا مشتقًا من جرد تكافؤ مقاس من نصوص الدروس، و141 هدفًا مقيسًا بلا فجوة)؛ تغيير المحتوى دون إعادة توليد التقارير يفشل Build.
