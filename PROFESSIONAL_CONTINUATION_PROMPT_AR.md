...
- 12 عائلة Zod صارمة تتحقق عند `prebuild` من 2,809 كائنًا أكاديميًا علويًا وبنيته المتداخلة، ومنها 192 سجل اسم و72 إطار فعل/حرف جر لـA1–A2 (96 اسمًا و24 إطارًا في A1، و96 اسمًا و48 إطارًا في A2)؛ تغيير المحتوى دون إعادة توليد التقارير يفشل Build.
...
- دفعة `a2-lexical-grammar-v1`: في 24/24 درس A2 تظهر 4 مراسي أسماء German-first بالأداة والجنس والجمع أو سياسة عدم الجمع والحالات الثلاث، وإطاران لفعل + حرف جر + حالة + Chunk + مثال + مقارنة عربية لكل درس، مأخوذة من نظرية الدرس ومفرداته الفعلية. المدقق يمنع تكرار Chunk داخل المستوى، ويرفض اسمًا بلا ملاحظة جمع، وإطارًا لا يحتوي chunkه حرف الجر أو الفعل المؤطّر. B1–B2 لم تؤلف بعد، ولا تُغطى كل أسماء وأفعال A1–A2.
- Hint ladder.
...
- التالي في 98/99: تأليف B1 ثم B2، ثم تدقيق كل اسم هدف وكل فعل ذي متمم جرّي في A1–B2 لا المراسي فقط.
