...
Top-level academic objects: 3,710/3,710
A1–B2 structured noun anchors: 685 entries across 84/84 lessons
A1–B2 verb-preposition-case frames: 104 entries across 84/84 lessons
...
```text
9ea69f7ff2d7453f4b50ff0ea6daef9e3ec7c8ba70901a4a795b18244bb5c7c1
```
...
The lexical grammar registry now contains 1,044 noun records and 104 frames. All A1–B2 machine target queues are zero: nouns 3,219 = 1,106 covered / 0 pending / 2,113 context; verbs 817 = 104 covered / 0 unclassified / 713 not-target. Six frame exclusions remain `authored-review-pending`. Independent German review is still mandatory before P0-98/99 close.
...
```text
Case-teaching contracts: 17/17
Theory references: 21
Controlled exercise references: 54
Mini-Test references: 40
Explicit case signals without an owner: 0
Required sequence: meaning → role → form
```

The generated artifacts are `docs/generated/MEANING_FIRST_CASE_REPORT.md` and `reports/case-teaching-audit.json`. They share case-content SHA-256 `d9c241d6e09bbc87622af7afb132e8d2349823b1af8ae93d61925ea8ec384f90`. This proves authored order and references, not independent linguistic approval of every explanation.

## Language and Bidi boundary audit

`language:audit` scans all 112 TSX files and 4,043 opening tags during `prebuild`. Current evidence includes 188 explicit German `lang=de/dir=ltr` fragments, 13 technical/numeric/secret scopes, 10 adaptive answer-bank renderers, and 137 Arabic+Latin static text nodes under plaintext/isolate containment, with zero pairing or raw-control issues. The generated artifacts are `docs/generated/LANGUAGE_BOUNDARY_REPORT.md` and `reports/language-boundary-audit.json`, sharing SHA-256 `cca1586eda10f7c95d559ab4ca843d9e07d6201bab7ba8224b0f14643eb09ed4`. Physical screen-reader speech-order review remains deferred.
