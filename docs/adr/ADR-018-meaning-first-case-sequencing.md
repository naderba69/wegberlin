...
The registry currently owns 17 lessons across A1–B2:
...
It maps 21 theory blocks, 54 controlled exercises, and 40 Mini-Test items. An independent detector finds 18 theory, 27 controlled, and 20 assessment objects that explicitly name a German case; every discovered ID belongs to a contract.
