...
`buildLessonListeningSequence` gives all 84 lessons the same bounded process while retaining each lesson's authored title, strategy, MP3, transcript, and questions:
...
- 84/84 lesson sequence contracts and ownership of the existing question IDs;
