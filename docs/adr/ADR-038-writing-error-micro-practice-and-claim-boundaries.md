...
`buildLessonClaimBoundary` produces exactly three non-overlapping cards for every one of the 84 lessons:
...
- all 84 lessons with exactly the three claim kinds and correct authority classes;
