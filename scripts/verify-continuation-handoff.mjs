...
if (cacheName !== "dwnb-full-pack-v63") fail(`unexpected current cache ${cacheName}`);
...
requireText(e2e, 'caches.open("dwnb-level-pack-a1-v63")', "Playwright level pack cache contract");
