...
for (const text of ["110 implemented, 11 partial, 2 not implemented", "365/365", "37/37", "301 generated static/SSG pages", "298/298", "298/51/51/51/199"])
  requireText(status, text, "PROJECT_STATUS.md");
for (const text of ["365/365", "37/37"]) requireText(readme, text, "README.md");
...
if (cacheName !== "dwnb-full-pack-v64") fail(`unexpected current cache ${cacheName}`);
...
requireText(e2e, 'caches.open("dwnb-level-pack-a1-v64")', "Playwright level pack cache contract");
...
console.log(`- delivery: ${offline.routeCount} Offline routes, ${cacheName}, 365 unit/integrity and 37+37 browser tests documented`);
