...
if (academicAudit.schema?.counts?.totalRootObjects !== 3025 || academicAudit.schema?.schemaFamilies !== 12) fail("academic Zod counters drifted");
if (academicAudit.schema?.counts?.nounGrammarEntries !== 336 || academicAudit.schema?.counts?.verbPrepositionFrames !== 144) fail("A1-B2 lexical grammar counters drifted");
...
for (const text of ["3,025", "2,584", "348", "336/336"]) requireText(prompt, text, "continuation prompt academic audit");
