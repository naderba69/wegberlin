...
export function OfflinePackControl() {
  ...
  return <section className="settings-card offline-pack-card">
    ...
    <p className="offline-pack-copy">
      كل مستوى حزمة مستقلة مع صفحات المنصة المشتركة. حزمة B2 تشمل تدريبات Goethe وtelc المنفصلة، بينما الحزمة الكاملة تضم 84 درسًا و306 مسارات. لا تشمل أي حزمة مفتاح AI أو التسجيلات الشخصية.
    </p>
