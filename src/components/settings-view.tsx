...
export function SettingsView() {
  ...
  return <div className="settings-page">
    <header className="page-heading"><div><span className="eyebrow"><ShieldCheck size={15} /> بياناتك ملكك</span><h1>الإعدادات <em>والنسخ المحلي</em></h1><p><BidiText text="تقدمك في IndexedDB. مفتاح AI أو عنوان Ollama يبقى في Session Storage ويُستبعد من النسخ الاحتياطية."/></p></div></header>
    {message && <div className="success-banner" role="status" aria-live="polite"><CheckCircle2 size={18} />{message}</div>}
    <div className="settings-grid">
      <section className="settings-card">
        <div className="settings-title"><span><HardDrive size={20} /></span><div><h2>الحفظ والنسخة الاحتياطية</h2><p><BidiText text={"ملف محمول قابل للتحقق بـSHA-256."}/></p></div></div>
        ...
        <div className="storage-meter"><div><span>بيانات التعلم</span><strong>محلية فقط</strong></div><i><b style={{ width: "12%" }} /></i><small><BidiText text={"التسجيلات الصوتية محفوظة في Media Store منفصل."}/></small></div>
        ...
        <div className="privacy-note"><FileArchive size={17} /><p><BidiText text={"يشمل التقدم والخطة والأخطاء والكتابة وسجل المرشد المنظم، ويمكن تضمين التسجيلات وتشفير الحمولة بـAES-GCM. عبارة المرور ومفتاح API مستبعدان دائمًا."}/></p></div>
      ...
      <section className="settings-card">
        ...
        <div className="privacy-note"><ShieldCheck size={17} /><p><BidiText text={"يسأل المرشد موافقتك قبل كل نص يُرسل إلى Gemini أو OpenRouter أو Ollama. Gemini مقيد بالموديلات المتحققة، وOpenRouter يقبل فقط `openrouter/free` أو معرّفًا ينتهي بـ`:free`، ولا يوجد Paid fallback."}/></p></div>
      </section>
