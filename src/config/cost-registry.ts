...
export const costRegistry = [
  ...
  {
    id: "browser-webgpu",
    purposeAr: "ترتيب دلالي اختياري لأسئلة المتابعة داخل المتصفح",
    mandatory: false,
    costStatus: "browser-local-zero-cost",
    paymentCardRequired: false,
    sourceIds: ["transformers-js-runtime-4-2-0", "transformers-js-webgpu-guide-2026-09", "multilingual-minilm-base-license-2026-09", "multilingual-minilm-onnx-web-2026-09"],
    quotaAr: "لا توجد حصة API؛ التنزيل الأول يقارب 130–150 MB ثم يعمل من Cache Storage حسب دعم WebGPU والجهاز.",
    fallbackAr: "محرك سؤال المتابعة الحتمي المحلي دون تنزيل نموذج.",
    privacyAr: "بعد اكتمال التنزيل يبقى نص الاستدلال داخل Web Worker على الجهاز؛ تنزيل الأوزان فقط يصل إلى Hugging Face.",
    owner: "learner",
  },
  {
    id: "browser-pronunciation",
    purposeAr: "مطابقة اختيارية للكلمات الألمانية داخل المتصفح",
    mandatory: false,
    costStatus: "browser-local-zero-cost",
    paymentCardRequired: false,
    sourceIds: ["transformers-js-runtime-4-2-0", "transformers-js-webgpu-guide-2026-09", "whisper-tiny-base-license-2026-09", "whisper-tiny-onnx-web-2026-09"],
    quotaAr: "لا توجد حصة API؛ التنزيل الأول يقارب 70–90 MB ثم يعمل من Cache Storage حسب دعم WebGPU والجهاز.",
    fallbackAr: "الاستماع والتسجيل والتشغيل والمقارنة الذاتية دون نموذج.",
    privacyAr: "بعد التثبيت يبقى التسجيل والتحليل داخل الجهاز؛ تنزيل الأوزان فقط يصل إلى Hugging Face.",
    owner: "learner",
  },
  {
    id: "vercel-hobby",
