...
export const examSources: ExamSourceReference[] = [
  {
    ...
    url: "https://www.goethe.de/ins/us/en/spr/prf/gzb2.cfm",
...
export const examProfiles: Record<ExamProfile["id"], ExamProfile> = {
  "goethe-b2": {
    ...
    modules: [
      ...
      { id: "hoeren", titleDe: "Hören", titleAr: "الاستماع", parts: 4, minutes: 40, maxPoints: 100, noteAr: "30 عنصرًا، كل عنصر نقطة قياس؛ المدة تقريبية وتتضمن وقت نقل الإجابات." },
