...
describe("P1 three-pass lesson listening sequence", () => {
  it("gives all 84 lessons a before, one gist, and after-detail contract tied to their authored questions", () => {
    const sequences = academicLessonList.map(buildLessonListeningSequence);
    expect(sequences).toHaveLength(84);
